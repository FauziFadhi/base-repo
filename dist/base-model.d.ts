...
export declare function base<TModelAttributes extends {} = any, TCreationAttributes extends {} = TModelAttributes, M extends readonly CacheKey[] = []>(caches: M): {
    new (values?: TCreationAttributes, options?: import("sequelize/types").BuildOptions): {
        ...
        reload(options?: FindOptions<any>): Promise<any>;
    ...
    beforeValidate<M_35 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_35>, name: string, fn: (instance: M_35, options: import("sequelize/types/lib/instance-validator").ValidationOptions) => void | Promise<void>): void;
    beforeValidate<M_36 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_36>, fn: (instance: M_36, options: import("sequelize/types/lib/instance-validator").ValidationOptions) => void | Promise<void>): void;
    afterValidate<M_37 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_37>, name: string, fn: (instance: M_37, options: import("sequelize/types/lib/instance-validator").ValidationOptions) => void | Promise<void>): void;
    afterValidate<M_38 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_38>, fn: (instance: M_38, options: import("sequelize/types/lib/instance-validator").ValidationOptions) => void | Promise<void>): void;
    beforeCreate<M_39 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_39>, name: string, fn: (instance: M_39, options: import("sequelize/types").CreateOptions<M_39["_attributes"]>) => void | Promise<void>): void;
    beforeCreate<M_40 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_40>, fn: (instance: M_40, options: import("sequelize/types").CreateOptions<M_40["_attributes"]>) => void | Promise<void>): void;
    afterCreate<M_41 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_41>, name: string, fn: (instance: M_41, options: import("sequelize/types").CreateOptions<M_41["_attributes"]>) => void | Promise<void>): void;
    afterCreate<M_42 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_42>, fn: (instance: M_42, options: import("sequelize/types").CreateOptions<M_42["_attributes"]>) => void | Promise<void>): void;
    beforeDestroy<M_43 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_43>, name: string, fn: (instance: M_43, options: import("sequelize/types").InstanceDestroyOptions) => void | Promise<void>): void;
    beforeDestroy<M_44 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_44>, fn: (instance: M_44, options: import("sequelize/types").InstanceDestroyOptions) => void | Promise<void>): void;
    afterDestroy<M_45 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_45>, name: string, fn: (instance: M_45, options: import("sequelize/types").InstanceDestroyOptions) => void | Promise<void>): void;
    afterDestroy<M_46 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_46>, fn: (instance: M_46, options: import("sequelize/types").InstanceDestroyOptions) => void | Promise<void>): void;
    beforeUpdate<M_47 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_47>, name: string, fn: (instance: M_47, options: import("sequelize/types").UpdateOptions<M_47["_attributes"]>) => void | Promise<void>): void;
    beforeUpdate<M_48 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_48>, fn: (instance: M_48, options: import("sequelize/types").UpdateOptions<M_48["_attributes"]>) => void | Promise<void>): void;
    afterUpdate<M_49 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_49>, name: string, fn: (instance: M_49, options: import("sequelize/types").UpdateOptions<M_49["_attributes"]>) => void | Promise<void>): void;
    afterUpdate<M_50 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_50>, fn: (instance: M_50, options: import("sequelize/types").UpdateOptions<M_50["_attributes"]>) => void | Promise<void>): void;
    beforeSave<M_51 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_51>, name: string, fn: (instance: M_51, options: import("sequelize/types").UpdateOptions<M_51["_attributes"]> | import("sequelize/types").SaveOptions<M_51["_attributes"]>) => void | Promise<void>): void;
    beforeSave<M_52 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_52>, fn: (instance: M_52, options: import("sequelize/types").UpdateOptions<M_52["_attributes"]> | import("sequelize/types").SaveOptions<M_52["_attributes"]>) => void | Promise<void>): void;
    afterSave<M_53 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_53>, name: string, fn: (instance: M_53, options: import("sequelize/types").UpdateOptions<M_53["_attributes"]> | import("sequelize/types").SaveOptions<M_53["_attributes"]>) => void | Promise<void>): void;
    afterSave<M_54 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_54>, fn: (instance: M_54, options: import("sequelize/types").UpdateOptions<M_54["_attributes"]> | import("sequelize/types").SaveOptions<M_54["_attributes"]>) => void | Promise<void>): void;
    beforeBulkCreate<M_55 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_55>, name: string, fn: (instances: M_55[], options: import("sequelize/types").BulkCreateOptions<M_55["_attributes"]>) => void | Promise<void>): void;
    beforeBulkCreate<M_56 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_56>, fn: (instances: M_56[], options: import("sequelize/types").BulkCreateOptions<M_56["_attributes"]>) => void | Promise<void>): void;
    afterBulkCreate<M_57 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_57>, name: string, fn: (instances: readonly M_57[], options: import("sequelize/types").BulkCreateOptions<M_57["_attributes"]>) => void | Promise<void>): void;
    afterBulkCreate<M_58 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_58>, fn: (instances: readonly M_58[], options: import("sequelize/types").BulkCreateOptions<M_58["_attributes"]>) => void | Promise<void>): void;
    beforeBulkDestroy<M_59 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_59>, name: string, fn: (options: import("sequelize/types").BulkCreateOptions<M_59["_attributes"]>) => void | Promise<void>): void;
    beforeBulkDestroy<M_60 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_60>, fn: (options: import("sequelize/types").BulkCreateOptions<M_60["_attributes"]>) => void | Promise<void>): void;
    afterBulkDestroy<M_61 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_61>, name: string, fn: (options: import("sequelize/types").DestroyOptions<M_61["_attributes"]>) => void | Promise<void>): void;
    afterBulkDestroy<M_62 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_62>, fn: (options: import("sequelize/types").DestroyOptions<M_62["_attributes"]>) => void | Promise<void>): void;
    beforeBulkUpdate<M_63 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_63>, name: string, fn: (options: import("sequelize/types").UpdateOptions<M_63["_attributes"]>) => void | Promise<void>): void;
    beforeBulkUpdate<M_64 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_64>, fn: (options: import("sequelize/types").UpdateOptions<M_64["_attributes"]>) => void | Promise<void>): void;
    afterBulkUpdate<M_65 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_65>, name: string, fn: (options: import("sequelize/types").UpdateOptions<M_65["_attributes"]>) => void | Promise<void>): void;
    afterBulkUpdate<M_66 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_66>, fn: (options: import("sequelize/types").UpdateOptions<M_66["_attributes"]>) => void | Promise<void>): void;
    beforeFind<M_67 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_67>, name: string, fn: (options: FindOptions<M_67["_attributes"]>) => void | Promise<void>): void;
    beforeFind<M_68 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_68>, fn: (options: FindOptions<M_68["_attributes"]>) => void | Promise<void>): void;
    beforeCount<M_69 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_69>, name: string, fn: (options: import("sequelize/types").CountOptions<M_69["_attributes"]>) => void | Promise<void>): void;
    beforeCount<M_70 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_70>, fn: (options: import("sequelize/types").CountOptions<M_70["_attributes"]>) => void | Promise<void>): void;
    beforeFindAfterExpandIncludeAll<M_71 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_71>, name: string, fn: (options: FindOptions<M_71["_attributes"]>) => void | Promise<void>): void;
    beforeFindAfterExpandIncludeAll<M_72 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_72>, fn: (options: FindOptions<M_72["_attributes"]>) => void | Promise<void>): void;
    beforeFindAfterOptions<M_73 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_73>, name: string, fn: (options: FindOptions<M_73["_attributes"]>) => void | Promise<void>): void;
    beforeFindAfterOptions<M_74 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_74>, fn: (options: FindOptions<M_74["_attributes"]>) => void): void | Promise<void>;
    afterFind<M_75 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_75>, name: string, fn: (instancesOrInstance: M_75 | readonly M_75[], options: FindOptions<M_75["_attributes"]>) => void | Promise<void>): void;
    afterFind<M_76 extends import("sequelize/types").Model<any, any>>(this: import("sequelize/types").ModelStatic<M_76>, fn: (instancesOrInstance: M_76 | readonly M_76[], options: FindOptions<M_76["_attributes"]>) => void | Promise<void>): void;
    beforeBulkSync(name: string, fn: (options: import("sequelize/types").SyncOptions) => void | Promise<void>): void;
    beforeBulkSync(fn: (options: import("sequelize/types").SyncOptions) => void | Promise<void>): void;
    afterBulkSync(name: string, fn: (options: import("sequelize/types").SyncOptions) => void | Promise<void>): void;
    afterBulkSync(fn: (options: import("sequelize/types").SyncOptions) => void | Promise<void>): void;
    beforeSync(name: string, fn: (options: import("sequelize/types").SyncOptions) => void | Promise<void>): void;
